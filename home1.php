        ...
        <nav class="nav1">
            <form>
                <ul class="nav">
                    ...
                    <li class="li1 nav-item">
                        <a href="test7.php" class="nav-link"><i class="fa-solid fa-user fa-fade"> ยกเลิกการเช่า</i></a>
                    </li>
                    <li class="li1 nav-item">
                    ...
                    <li class="li1 nav-item">
                        <a class="nav-link" href="test8.php"><i class="fa-solid fa-money-bill"></i>ค่าใช่จ่ายต่อเดือน</a>
                    </li>
                    <li class="li1 nav-item">
