...
<nav class="nav1">
    ...
    <ul class="nav">
        ...
        <li class="li1 nav-item">
            <a class="nav-link active" href="test3.php"><i class="fa-solid fa-bolt fa-fade"></i></a>
        </li>
        <li class="li1 nav-item">
...
<article>
        ...
        <?php   }
            ...
            <a href="testfont3.php" style="text-align: center;"><i class="fa-solid fa-print fa-flip fa-2xl"></i></i></a>
        </article>
</section>
<footer>
