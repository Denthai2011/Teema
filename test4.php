...
<nav class="nav1">
    ...
    <ul class="nav">
        ...
        <li class="li1 nav-item">
            <a class="nav-link active" href="test4.php"><i class="fa-regular fa-flag fa-fade"></i></a>
        </li>
    </form>
        <li class="li2">
...
<div class="container">
            ...
            <a href="testfont4.php" style="text-align: center;"><i class="fa-solid fa-print fa-flip fa-2xl"></i></i></a>
            </article>
</section>
<footer>
