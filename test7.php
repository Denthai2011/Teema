                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item bg-success" href="test7.php">การยกเลิกการเช่า</a>
                        </div>
                    </div>
                </li>
                            ...
                            <table class="table  table-bordered table-hover">
                                ...
                                <tbody style="text-align:center;">
                                    <tr>
                                        ...
                                        <td style="width: 150px;"><?php echo $row["End_ren"] ?></td>

                                        <td style="width: 100px;">
                                            <div class="">
                                                <button type="button" class="btn btn-danger " data-bs-toggle="modal" data-bs-target="#End_<?php echo $row['renId'] ?>">เลิกเช่า</button>
                                            </div>
