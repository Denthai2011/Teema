...
$sql = "SELECT * FROM elect";
                    ...
                    if ($result) {
                        foreach ($result as $row) {
                            $E_id = $row['E_id'];
$pdf -> SetX(30);
$pdf -> Cell(40,10,iconv('utf-8','cp874',$row["E_id"]),1,0,'C');
$pdf -> Cell(40,10,iconv('utf-8','cp874',$row["E_dsave"]),1,0,'C');
$pdf -> Cell(40,10,iconv('utf-8','cp874',$row["E_bef"]),1,0,'C');
$pdf -> Cell(40,10,iconv('utf-8','cp874',$row["E_af"]),1,1,'C');
